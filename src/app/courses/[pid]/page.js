        ...
        <div className="lg:grid lg:grid-cols-2 lg:gap-8 xl:gap-16">
          ...
          <div className="mt-6 sm:mt-8 lg:mt-0">
            ...
            <p className="text-gray-500 dark:text-gray-400">
              Two Thunderbolt USB 4 ports and up to two USB 3 ports. Ultrafast Wi-Fi 6 and
              Bluetooth 5.0 wireless. Color matched Magic Mouse with Magic Keyboard or Magic
