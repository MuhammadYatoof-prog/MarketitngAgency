"use client";// This is a client component like header is a section not full page component, which means it will be rendered on the client side and can use React hooks and other client-side features.
